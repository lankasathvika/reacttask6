      ...
      <div className="main-content">
        {selectedSection === "Home" && (
          <div className="content-section">
            ...
            <p>
              I'm sathvika, a web developer who's dedicated to crafting
...
monitor and assess the health and performance of electric vehicle (EV) motors in real-time.
            ...
            <div className="content-section">
              <h2>About Me</h2>
              <p>
                Hi, I'm sathvika, a web developer with expertise in HTML and
            ...
            <div className="content-section">
              ...
              <div className="content-section">
                ...
                <p>Right Now I am working in  NGC club of VIT-AP University.</p>
              </div>
              ...
              <div className="content-section">
                <h2>Contact Me</h2>
                <p>Name: sathvika</p>
                <p>Mobile: 8465098425</p>
                <p>Email: lankasathvika27@gmail.com</p>
                <p>
                  Linkedin:{" "}
                  <a href="https://www.linkedin.com/in/lanka-sathvika-a76497225?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
                    {" "}
                    sathvika{" "}
                  </a>
                </p>
      ...
      {selectedSection === "About" && (
        <div className="content-section">
          <h2>About Me</h2>
          <p>
            Hi, I'm sathvika, a web developer with expertise in HTML and CSS.
